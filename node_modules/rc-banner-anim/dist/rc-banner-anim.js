...
/* harmony default export */ __webpack_exports__["a"] = ({
  across: function across(elem, type, direction, animData, elemOffset, leaveChildHide) {
    ...
    if (type === 'enter') {
      ...
      _x = direction === 'next' ? '-100%' : '100%';
      children = Object(__WEBPACK_IMPORTED_MODULE_2__utils__["f" /* toArrayChildren */])(children).map(__WEBPACK_IMPORTED_MODULE_2__utils__["e" /* switchChildren */].bind(this, leaveChildHide));
    }
    return Object(__WEBPACK_IMPORTED_MODULE_1_react__["cloneElement"])(elem, {
  ...
  vertical: function vertical(elem, type, direction, animData, elemOffset, leaveChildHide) {
    ...
    return Object(__WEBPACK_IMPORTED_MODULE_1_react__["cloneElement"])(elem, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, props, {
      animation: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, animData, {
        y: _y,
        type: type === 'enter' ? 'from' : 'to'
      })
  ...
  gridBar: function gridBar(elem, type, direction, animData, elemOffset, leaveChildHide, ratio, paused) {
    ...
    for (var i = 0; i < gridNum; i++) {
      ...
      var _style = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, props.style);
      ...
      var animProps = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, props);
      animProps.style = _style;
      var delay = (direction === 'next' ? i : gridNum - i) * 50 + (type === 'enter' ? 0 : 50) + (animData.delay || 0);
      animProps.animation = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, animData, {
        y: _y,
        type: type === 'enter' ? 'from' : 'to',
        key: type,
        direction: direction,
      ...
      var mask = __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
        'div',
        { style: style, key: i },
        Object(__WEBPACK_IMPORTED_MODULE_1_react__["cloneElement"])(elem, animProps, children)
      );
      animChild.push(mask);
    }
    var animSlot = __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
      'div',
      { style: { width: '100%', position: 'absolute', top: 0 } },
      animChild
    );
    var _props = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, elem.props);
    _props.children = animSlot;
    return Object(__WEBPACK_IMPORTED_MODULE_1_react__["cloneElement"])(elem, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, _props, { animation: { x: 0, y: 0, type: 'set' } }));
  },
  grid: function grid(elem, type, direction, animData, elemOffset, leaveChildHide, ratio, paused) {
    ...
    if (type === 'leave') {
      props.animation = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, animData, {
        duration: _delay + animData.duration
      });
      props.moment = ((animData.delay || 0) + _delay + animData.duration) * ratio || 0;
      props.paused = paused;
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.cloneElement(elem, props);
    }
    ...
    for (var i = 0; i < gridNum * gridNumH; i++) {
      ...
      var animation = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, animData, {
        opacity: 1,
        delay: delay,
      ...
      var mask = __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1_react__["cloneElement"])(elem, props)
      );
      animChild.push(mask);
    }
    var _props = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, elem.props);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return ticker; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Tween__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TweenOneGroup__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__easing__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__plugins__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ticker__ = __webpack_require__(64);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_react_dom__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__Tween__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ticker__ = __webpack_require__(64);
...
/* harmony default export */ __webpack_exports__["a"] = (Object(__WEBPACK_IMPORTED_MODULE_9_react_lifecycles_compat__["a" /* polyfill */])(TweenOne));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_style_utils__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__easing__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__plugins__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__plugin_StylePlugin__ = __webpack_require__(117);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tween_functions__ = __webpack_require__(63);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_raf__ = __webpack_require__(118);
...
var Arrow = function (_Component) {
  __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_inherits___default()(Arrow, _Component);
  ...
  function Arrow() {
    ...
    __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_classCallCheck___default()(this, Arrow);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_possibleConstructorReturn___default()(this, (_ref = Arrow.__proto__ || Object.getPrototypeOf(Arrow)).call.apply(_ref, [this].concat(args))), _this), _this.onClick = function (e) {
  ...
  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(Arrow, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          ...
          props = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_objectWithoutProperties___default()(_props, ['arrowType', 'next', 'prev', 'component', 'componentProps', 'defaultBool', 'prefixCls', 'children']);
      ...
      var $props = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, props, componentProps, {
        className: className,
        onClick: this.onClick
      });
      return __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(component, $props, children);
    }
  }]);
...
Arrow.propTypes = {
  ...
  component: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.any,
  arrowType: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.string,
  defaultBool: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.bool,
  next: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.func,
  prev: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.func,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_prop_types__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__utils__ = __webpack_require__(19);
...
var Thumb = function (_Component) {
  __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_inherits___default()(Thumb, _Component);
  ...
  function Thumb() {
    ...
    __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_classCallCheck___default()(this, Thumb);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_possibleConstructorReturn___default()(this, (_ref = Thumb.__proto__ || Object.getPrototypeOf(Thumb)).call.apply(_ref, [this].concat(args))), _this), _this.getDefaultThumb = function () {
      var children = [];
      for (var i = 0; i < _this.props.length; i++) {
        children.push(__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement('span', { key: i }));
      }
      return children;
    }, _temp), __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_possibleConstructorReturn___default()(_this, _ret);
  }

  __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(Thumb, [{
    key: 'render',
    value: function render() {
      var _props = this.props,
          ...
          props = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_objectWithoutProperties___default()(_props, ['length', 'thumbClick', 'active', 'defaultBool', 'component', 'componentProps', 'prefixCls', 'children']);
      ...
      if (length && Object(__WEBPACK_IMPORTED_MODULE_8__utils__["f" /* toArrayChildren */])(children).length !== length) {
        console.warn('The thumbnail length and the images length different.'); // eslint-disable-line
      }
      var childToRender = Object(__WEBPACK_IMPORTED_MODULE_8__utils__["f" /* toArrayChildren */])(children).map(function (item, i) {
        var itemProps = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, item.props);
        ...
        return __WEBPACK_IMPORTED_MODULE_6_react___default.a.cloneElement(item, itemProps);
      });
      var $props = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, props, componentProps, { className: className });

      return __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(component, $props, childToRender);
    }
  }]);
...
Thumb.propTypes = {
  ...
  prefixCls: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.string,
  component: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.any,
  thumbClick: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.func,
  defaultBool: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.bool,
  length: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.number,
  active: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.number,
  componentProps: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.object
};
Thumb.defaultProps = {
  component: 'div',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_lifecycles_compat__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__BannerAnim__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Arrow__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Element__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Thumb__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__anim__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils__ = __webpack_require__(19);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Arrow", function() { return __WEBPACK_IMPORTED_MODULE_2__Arrow__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Element", function() { return __WEBPACK_IMPORTED_MODULE_3__Element__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Thumb", function() { return __WEBPACK_IMPORTED_MODULE_4__Thumb__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "animType", function() { return __WEBPACK_IMPORTED_MODULE_5__anim__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "setAnimCompToTagComp", function() { return __WEBPACK_IMPORTED_MODULE_6__utils__["d"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "switchChildren", function() { return __WEBPACK_IMPORTED_MODULE_6__utils__["e"]; });
// export this package's api
...
__WEBPACK_IMPORTED_MODULE_1__BannerAnim__["a" /* default */].Arrow = __WEBPACK_IMPORTED_MODULE_2__Arrow__["a" /* default */];
__WEBPACK_IMPORTED_MODULE_1__BannerAnim__["a" /* default */].Element = __WEBPACK_IMPORTED_MODULE_3__Element__["a" /* default */];
__WEBPACK_IMPORTED_MODULE_1__BannerAnim__["a" /* default */].Thumb = __WEBPACK_IMPORTED_MODULE_4__Thumb__["a" /* default */];
__WEBPACK_IMPORTED_MODULE_1__BannerAnim__["a" /* default */].animType = __WEBPACK_IMPORTED_MODULE_5__anim__["a" /* default */];
__WEBPACK_IMPORTED_MODULE_1__BannerAnim__["a" /* default */].setAnimCompToTagComp = __WEBPACK_IMPORTED_MODULE_6__utils__["d" /* setAnimCompToTagComp */];
__WEBPACK_IMPORTED_MODULE_1__BannerAnim__["a" /* default */].switchChildren = __WEBPACK_IMPORTED_MODULE_6__utils__["e" /* switchChildren */];

/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_0_react_lifecycles_compat__["a" /* polyfill */])(__WEBPACK_IMPORTED_MODULE_1__BannerAnim__["a" /* default */]));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Arrow__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__Thumb__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__utils__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__anim__ = __webpack_require__(31);
...
var BannerAnim = function (_Component) {
  __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_inherits___default()(BannerAnim, _Component);

  __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default()(BannerAnim, null, [{
    key: 'getDerivedStateFromProps',
    value: function getDerivedStateFromProps(props, _ref) {
      var prevProps = _ref.prevProps,
          $self = _ref.$self;
  ...
  function BannerAnim(props) {
    __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_classCallCheck___default()(this, BannerAnim);

    var _this = __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_possibleConstructorReturn___default()(this, (BannerAnim.__proto__ || Object.getPrototypeOf(BannerAnim)).call(this, props));

    _this.onMouseEnter = function (e) {
      _this.props.onMouseEnter(e);
      if (_this.props.autoPlay && _this.props.autoPlayEffect) {
        __WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["c" /* ticker */].clear(_this.autoPlayId);
        _this.autoPlayId = -1;
      }
    };
    ...
    _this.onTouchMove = function (e) {
      ...
      if ((_this.animType === __WEBPACK_IMPORTED_MODULE_13__anim__["a" /* default */].gridBar || _this.animType === __WEBPACK_IMPORTED_MODULE_13__anim__["a" /* default */].grid) && e.touches) {
        return;
      }
      _this.ratio = ratio;
      if (_this.ratio) {
    ...
    _this.onTouchEnd = function (e) {
      ...
      if ((_this.animType === __WEBPACK_IMPORTED_MODULE_13__anim__["a" /* default */].gridBar || _this.animType === __WEBPACK_IMPORTED_MODULE_13__anim__["a" /* default */].grid) && e.changedTouches) {
        var currentShow = _this.currentShow;
        var ratio = differ / _this.state.domRect[rectName] * 2;
        if (ratio < 0) {
          currentShow += 1;
    ...
    _this.getRenderChildren = function (children) {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_12__utils__["f" /* toArrayChildren */])(children).forEach(function (item, i) {
        if (!item) {
          return;
        }
        var itemProps = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({}, item.props);
        if (item.type.isBannerAnimElement) {
          ...
          elem.push(__WEBPACK_IMPORTED_MODULE_6_react___default.a.cloneElement(item, itemProps));
          ...
          arrow.push(__WEBPACK_IMPORTED_MODULE_6_react___default.a.cloneElement(item, itemProps));
          ...
          thumb = __WEBPACK_IMPORTED_MODULE_6_react___default.a.cloneElement(item, itemProps);
        }
      });
      if (elem.length > 1) {
        if (!arrow.length && _this.props.arrow) {
          arrow.push(__WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10__Arrow__["a" /* default */], { arrowType: 'prev', key: 'arrowPrev', next: _this.next, prev: _this.prev, defaultBool: true }), __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10__Arrow__["a" /* default */], { arrowType: 'next', key: 'arrowNext', next: _this.next, prev: _this.prev, defaultBool: true }));
        }
        if (!thumb && _this.props.thumb) {
          thumb = __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11__Thumb__["a" /* default */], { length: elem.length, key: 'thumb',
    ...
    _this.getDomDataSetToState = function () {
      _this.dom = __WEBPACK_IMPORTED_MODULE_7_react_dom___default.a.findDOMNode(_this);
    ...
    _this.getAnimType = function (type) {
      var typeArray = type ? Object(__WEBPACK_IMPORTED_MODULE_12__utils__["c" /* dataToArray */])(type) : Object.keys(__WEBPACK_IMPORTED_MODULE_13__anim__["a" /* default */]);
      var random = Math.round(Math.random() * (typeArray.length - 1));
      return __WEBPACK_IMPORTED_MODULE_13__anim__["a" /* default */][typeArray[random]];
    };

    _this.autoPlay = function () {
      if (!_this.mouseStartXY) {
        __WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["c" /* ticker */].clear(_this.autoPlayId);
        _this.autoPlayId = __WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["c" /* ticker */].interval(_this.next, _this.props.autoPlaySpeed);
      }
    };
  ...
  __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default()(BannerAnim, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
    ...
    value: function componentWillUnmount() {
      if (this.autoPlayId) {
        __WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["c" /* ticker */].clear(this.autoPlayId);
        this.autoPlayId = 0;
      }
      if (window.addEventListener) {
    ...
    value: function render() {
      var _props = this.props,
          ...
          props = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_objectWithoutProperties___default()(_props, ['type', 'prefixCls', 'component', 'initShow', 'duration', 'delay', 'ease', 'arrow', 'thumb', 'autoPlaySpeed', 'autoPlay', 'sync', 'dragPlay', 'autoPlayEffect']);

      var childrenToRender = this.getRenderChildren(props.children);
      props.className = (props.className + ' ' + (prefixCls || '')).trim();
      props.style = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({}, props.style);
      ...
      return __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(this.props.component, props, childrenToRender);
    }
  }]);
...
BannerAnim.propTypes = {
  ...
  arrow: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.bool,
  thumb: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.bool,
  initShow: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.number,
  ...
  autoPlay: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.bool,
  autoPlaySpeed: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.number,
  autoPlayEffect: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.bool,
  ...
  sync: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.bool,
  dragPlay: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.bool
};
...
/* harmony default export */ __webpack_exports__["a"] = (BannerAnim);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__TweenOne__ = __webpack_require__(60);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_react_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_react_lifecycles_compat__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_rc_tween_one__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_tween_functions__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_tween_functions___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_tween_functions__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_style_utils__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_style_utils___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12_style_utils__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__BgElement__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__utils__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__anim__ = __webpack_require__(31);
...
var Element = function (_Component) {
  __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_inherits___default()(Element, _Component);

  __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default()(Element, null, [{
    key: 'getDerivedStateFromProps',
    value: function getDerivedStateFromProps(props, _ref) {
      var prevProps = _ref.prevProps,
          $self = _ref.$self;
      ...
      if (prevProps && props !== prevProps) {
        if ($self.tickerId !== -1) {
          __WEBPACK_IMPORTED_MODULE_10_rc_tween_one__["c" /* ticker */].clear($self.tickerId);
          $self.tickerId = -1;
        }
  ...
  function Element(props) {
    ...
    var _this = __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_possibleConstructorReturn___default()(this, (Element.__proto__ || Object.getPrototypeOf(Element)).call(this, props));
    ...
    _this.transform = Object(__WEBPACK_IMPORTED_MODULE_12_style_utils__["checkStyleName"])('transform');
    return _this;
  }

  __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default()(Element, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      this.dom = __WEBPACK_IMPORTED_MODULE_8_react_dom___default.a.findDOMNode(this);
    }
    ...
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      __WEBPACK_IMPORTED_MODULE_10_rc_tween_one__["c" /* ticker */].clear(this.timeoutID);
      __WEBPACK_IMPORTED_MODULE_10_rc_tween_one__["c" /* ticker */].clear(this.delayTimeout);
      this.delayTimeout = -1;
      this.timeoutID = -1;
    }
  }, {
    ...
    value: function render() {
      var _props = this.props,
          ...
          componentProps = _props.componentProps,
          props = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_objectWithoutProperties___default()(_props, ['prefixCls', 'callBack', 'animType', 'duration', 'delay', 'ease', 'elemOffset', 'followParallax', 'show', 'type', 'direction', 'leaveChildHide', 'sync', 'ratio', 'mouseMoveType', 'children', 'style', 'componentProps']);

      var _state = this.state,
          currentShow = _state.show,
          currentMouseMoveType = _state.mouseMoveType;

      var style = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, propsStyle);
      ...
      var bgElem = Object(__WEBPACK_IMPORTED_MODULE_14__utils__["f" /* toArrayChildren */])(children).filter(function (item) {
        return item && item.type.isBannerAnimBgElement;
      }).map(function (item) {
        return __WEBPACK_IMPORTED_MODULE_6_react___default.a.cloneElement(item, { show: props.show });
      });
      if (currentShow === show && !currentMouseMoveType || currentMouseMoveType === 'reChild') {
        ...
        if (!show) {
          ...
          return __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10_rc_tween_one__["b" /* default */], props, bgElem);
        }
        if (followParallax) {
          props.onMouseMove = this.getFollowMouseMove();
        }
        return __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10_rc_tween_one__["b" /* default */], props, mouseMoveType === 'update' ? bgElem : this.getChildren());
      }
      var $props = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, props, componentProps);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.onMouseMove = function (e) {
    ...
    _this2.offsetTop = _this2.domRect.top + Object(__WEBPACK_IMPORTED_MODULE_14__utils__["b" /* currentScrollTop */])();
    _this2.offsetLeft = _this2.domRect.left + Object(__WEBPACK_IMPORTED_MODULE_14__utils__["a" /* currentScrollLeft */])();
    var mouseXY = {
  ...
  this.setTicker = function (followParallax, mouseXY) {
    ...
    __WEBPACK_IMPORTED_MODULE_10_rc_tween_one__["c" /* ticker */].clear(_this2.tickerId);
    _this2.tickerId = 'bannerElementTicker' + (Date.now() + Math.random());
    var startFrame = __WEBPACK_IMPORTED_MODULE_10_rc_tween_one__["c" /* ticker */].frame;
    var startX = _this2.enterMouse.x;
    var startY = _this2.enterMouse.y;
    var duration = followParallax.duration || 450;
    var easeFunc = __WEBPACK_IMPORTED_MODULE_11_tween_functions___default.a[followParallax.ease || 'easeOutQuad'];
    var start = typeof followParallax.minMove === 'number' ? followParallax.minMove : 0.08;
    __WEBPACK_IMPORTED_MODULE_10_rc_tween_one__["c" /* ticker */].wake(_this2.tickerId, function () {
      var moment = (__WEBPACK_IMPORTED_MODULE_10_rc_tween_one__["c" /* ticker */].frame - startFrame) * __WEBPACK_IMPORTED_MODULE_10_rc_tween_one__["c" /* ticker */].perFrame;
  ...
  this.getFollowMouseMove = function () {
    ...
    if (_this2.followParallax) {
      if (_this2.followParallax.delay) {
        ...
        _this2.delayTimeout = _this2.delayTimeout || __WEBPACK_IMPORTED_MODULE_10_rc_tween_one__["c" /* ticker */].timeout(function () {
          _this2.setState({
  ...
  this.getFollowStyle = function (data, domWH) {
    var style = {};
    Object(__WEBPACK_IMPORTED_MODULE_14__utils__["c" /* dataToArray */])(data.type).forEach(function (type) {
      ...
      var _type = Object(__WEBPACK_IMPORTED_MODULE_12_style_utils__["getGsapType"])(type);
      var cssName = Object(__WEBPACK_IMPORTED_MODULE_12_style_utils__["isConvert"])(_type);
      if (cssName === 'transform') {
        var transform = Object(__WEBPACK_IMPORTED_MODULE_12_style_utils__["checkStyleName"])('transform');
        style[transform] = style[transform] || {};
        style[transform][_type] = Object(__WEBPACK_IMPORTED_MODULE_12_style_utils__["stylesToCss"])(_type, d).trim();
      } else if (cssName === 'filter') {
        var filter = Object(__WEBPACK_IMPORTED_MODULE_12_style_utils__["checkStyleName"])('filter');
        style[filter] = style[filter] || {};
        style[filter][_type] = Object(__WEBPACK_IMPORTED_MODULE_12_style_utils__["stylesToCss"])(_type, d).trim();
      } else {
        style[cssName] = Object(__WEBPACK_IMPORTED_MODULE_12_style_utils__["stylesToCss"])(_type, d).trim();
      }
    });
    return style;
  };
  ...
  this.getChildren = function () {
    return Object(__WEBPACK_IMPORTED_MODULE_14__utils__["f" /* toArrayChildren */])(_this2.props.children).map(function (item, i) {
      if (item && item.type === __WEBPACK_IMPORTED_MODULE_13__BgElement__["a" /* default */]) {
        return __WEBPACK_IMPORTED_MODULE_6_react___default.a.cloneElement(item, { show: _this2.state.show });
      }
      return _this2.useTagComp ? Object(__WEBPACK_IMPORTED_MODULE_14__utils__["d" /* setAnimCompToTagComp */])(item, i) : item;
    });
  };
  ...
  this.animChildren = function (props, style, bgElem) {
    ...
    if (_this2.delayTimeout) {
      __WEBPACK_IMPORTED_MODULE_10_rc_tween_one__["c" /* ticker */].clear(_this2.delayTimeout);
    ...
    _this2.useTagComp = (currentAnimType === __WEBPACK_IMPORTED_MODULE_15__anim__["a" /* default */].gridBar || currentAnimType === __WEBPACK_IMPORTED_MODULE_15__anim__["a" /* default */].grid) && (show === _this2.state.show || _this2.state.show && !show);
    // 状态没改，锁定 children 
    props.children = !sync && (show && show !== _this2.state.show || !show && !_this2.state.show) ? bgElem : _this2.getChildren();
    var childrenToRender = __WEBPACK_IMPORTED_MODULE_6_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10_rc_tween_one__["b" /* default */], props);
    ...
    var tagProps = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_objectWithoutProperties___default()(tag.props, []);
    ...
    return __WEBPACK_IMPORTED_MODULE_6_react___default.a.cloneElement(tag, tagProps);
  };
};
...
Element.propTypes = {
  ...
  prefixCls: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.string,
  component: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.any,
  elemOffset: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.object,
  type: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.string,
  animType: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.func,
  ...
  callBack: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.func,
  followParallax: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.any,
  show: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.bool,
  leaveChildHide: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.bool,
  sync: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.bool,
  ratio: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.number,
  mouseMoveType: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.string,
  componentProps: __WEBPACK_IMPORTED_MODULE_7_prop_types___default.a.object
};
...
Element.BgElement = Object(__WEBPACK_IMPORTED_MODULE_9_react_lifecycles_compat__["a" /* polyfill */])(__WEBPACK_IMPORTED_MODULE_13__BgElement__["a" /* default */]);
Element.isBannerAnimElement = true;
/* harmony default export */ __webpack_exports__["a"] = (Object(__WEBPACK_IMPORTED_MODULE_9_react_lifecycles_compat__["a" /* polyfill */])(Element));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_rc_tween_one__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_style_utils__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_style_utils___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_style_utils__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__utils__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__anim__ = __webpack_require__(31);
...
var BgElement = function (_React$Component) {
  __WEBPACK_IMPORTED_MODULE_5_babel_runtime_helpers_inherits___default()(BgElement, _React$Component);

  __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default()(BgElement, null, [{
    key: 'getDerivedStateFromProps',
    value: function getDerivedStateFromProps(props, _ref) {
      var prevProps = _ref.prevProps,
          $self = _ref.$self;
  ...
  function BgElement(props) {
    __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_classCallCheck___default()(this, BgElement);

    var _this = __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_possibleConstructorReturn___default()(this, (BgElement.__proto__ || Object.getPrototypeOf(BgElement)).call(this, props));

    _this.onScroll = function () {
      var scrollTop = Object(__WEBPACK_IMPORTED_MODULE_11__utils__["b" /* currentScrollTop */])();
      var domRect = _this.dom.parentNode.getBoundingClientRect();
      var offsetTop = domRect.top + scrollTop;
      var height = Math.max(domRect.height, Object(__WEBPACK_IMPORTED_MODULE_11__utils__["g" /* windowHeight */])());
    ...
    _this.onResize = function () {
      ...
      Object.keys(videoRect).forEach(function (key) {
        _this.video.style[key] = Object(__WEBPACK_IMPORTED_MODULE_10_style_utils__["stylesToCss"])(key, videoRect[key]);
      });
    };
    ...
    _this.isVideo = Object(__WEBPACK_IMPORTED_MODULE_11__utils__["f" /* toArrayChildren */])(props.children).some(function (item) {
      return item.type === 'video';
    });
    if (_this.isVideo) {
      // 如果是 video，删除 grid 系列，位置发生变化，重加载了 video;
      delete __WEBPACK_IMPORTED_MODULE_12__anim__["a" /* default */].grid;
      delete __WEBPACK_IMPORTED_MODULE_12__anim__["a" /* default */].gridBar;
    }
  ...
  __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_createClass___default()(BgElement, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      ...
      if (this.props.scrollParallax) {
        this.tween = new __WEBPACK_IMPORTED_MODULE_9_rc_tween_one__["a" /* Tween */](this.dom, [__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({
...
/* harmony default export */ __webpack_exports__["a"] = (BgElement);
...
BgElement.propTypes = {
  ...
  children: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.any,
  component: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.any,
  videoResize: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.bool,
  scrollParallax: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.object,
  show: __WEBPACK_IMPORTED_MODULE_8_prop_types___default.a.bool,
